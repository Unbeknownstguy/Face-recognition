...
# Loading the jpg file into a numpy array
...
for face_location in face_locations:
    ...
    # Printing the location of each face in this image. Each face is a list of co-ordinates in (top, right, bottom, left) order.
